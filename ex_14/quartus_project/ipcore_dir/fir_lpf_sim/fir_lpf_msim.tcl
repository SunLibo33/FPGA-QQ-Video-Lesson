...
set core_version 12.0
set device_family CYCLONEIVE
set quartus_rootdir C:/altera/12.0/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists fir_lpf.vhd]} {vcom -93 -work work fir_lpf.vhd}
    if {[file exists fir_lpf.v]} {vlog -work work fir_lpf.v}
    vcom -93 -work work fir_lpf_ast.vhd
    vcom -93 -work work fir_lpf_rtl.vhd

    if { [file exists fir_lpf_rtl_wysiwyg.vhd] } {
        vcom -93 -work work fir_lpf_rtl_wysiwyg.vhd
    }
